const galleryAboutData = [
  {
    ...
    description:
      "a passionate programmer from SMKN 46 who thrives on exploring the dynamic world of JavaScript and cutting-edge technology. With a deep curiosity and a relentless drive for innovation,  efficient web applications and diving into the latest tech trends like AI, IoT etc. Combines technical expertise with a collaborative mindset, making a significant impact in every project. Driven by a commitment to continuous learning and a love for tech, my self is on a mission to shape the future of digital experiences.",
