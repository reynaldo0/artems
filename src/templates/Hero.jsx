  ...
  return (  
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white p-4">
        <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold" data-aos="fade-up" data-aos-duration="1200">
          {title}
        </h1>
      ...
      <div className="relative z-50 bottom-32 md:bottom-28 left-0 w-full flex flex-col items-center p-2 md:p-6 py-10" data-aos="fade-up" data-aos-duration="1500">
