...
const Gallery = () => {
  ...
  useEffect(() => {
    const handleResize = () => {
      setIsDesktop(window.innerWidth >= 768); // Desktop width threshold
    };
  ...
  // Initialize AOS with default mobile animations
  useEffect(() => {
    AOS.init({
      duration: 1000, // Animation duration
      offset: 200, // Offset before animation starts
      easing: 'ease-in-out',
      once: false, // Allow animations to repeat (especially for mobile)
    });

    AOS.refresh(); // Refresh AOS to ensure animations apply correctly on page transition
  }, [pathname]);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 w-full">
        ...
        <div className="relative md:absolute md:left-[21rem] flex flex-col md:flex-row col-span-1 mt-2 md:mt-0">
          ...
          <div className="flex flex-col pt-5 md:pt-20 md:pl-16 w-full md:w-3/5">
            <h2
              className="text-3xl font-bold mb-4 md:text-7xl"
              data-aos={isDesktop ? "fade-left" : "fade-up"}
              data-aos-duration="1000"
            >
              {mainImage.title}
            ...
            <div className="flex flex-row pt-10 md:pt-16 gap-12 md:gap-40">
              <div className="flex flex-col">
                <p data-aos={isDesktop ? "fade-left" : "fade-up"} data-aos-duration="1000">
                  Born
                </p>
                <p className="font-bold text-lg" data-aos={isDesktop ? "fade-left" : "fade-up"} data-aos-duration="1100">
                  {born}
                </p>
              </div>
              <div className="flex flex-col">
            ...
            <div className="flex pt-10" data-aos={isDesktop ? "fade-left" : "fade-up"} data-aos-duration="1200">
